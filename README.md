...
There are two versions of the module, which differ in the multiplexer used. Model A uses the 74HCT257, whilst model B uses the 74HCT253.

**PLEASE NOTE!** An experimental version was mistakenly made available in this repository; it contained an error whereby the /Er pin of the 74HCT670 chips was connected to ground instead of the /MEN signal. Anyone who has built a PCB with this error must make the necessary corrections!

### Schematic

[Schematic - Version 1.0A](schematica.pdf)

[Schematic - Version 1.0B](schematicb.pdf)
...
| Integrated Circuit | U3*       | 74HCT257 - 4x2-input multiplexer, 16 pin DIP model A | 1*       |
|                    |           | 74HCT253 - 2x4-input multiplexer, 16 pin DIP model B | 1*       |
